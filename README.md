...
# 💫 About Me:
<br><br>I am a Full-Stack Developer focused on building modern web applications using the MERN Stack.<br><br>I work with MongoDB, Express.js, React.js, and Node.js to develop scalable and user-friendly applications. I also have hands-on knowledge of Git, Docker, Jenkins, Kubernetes, AWS, and CI/CD.<br><br>I enjoy learning new technologies, building projects, and improving my development and deployment skills.
